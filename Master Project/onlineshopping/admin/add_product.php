...
<div class="input-group">
      ...
      <input type="text" class="form-control" name="price" id="price"  placeholder="0" required>
    </div><br>
...
<h3>Category</h3>  
<p>Product type</p>
<input type="number" name="product_type" id="product_type" class="form-control" placeholder="1 Women,2 Men">
<br>
<p>Vendor / Brand</p>
<input type="number" name="brand" id="brand" class="form-control" placeholder="1 Gucci,2 Versace,3 Channel,4 Prada">
<br>
<p>Other tags</p>
<input type="text" name="tags" id="tags" class="form-control" placeholder="Shoes, Wallet">
</div>          
</div>
