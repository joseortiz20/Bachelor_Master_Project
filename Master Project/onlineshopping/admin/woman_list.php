...
$result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products  where  product_cat=1 Limit $page1,10")or die ("query 1 incorrect.....");
...
<a class=' btn btn-success' href='woman_list.php?product_id=$product_id&action=delete'>Delete</a>
</td></tr>";
}
...
<li><a class="label-info" href="woman_list.php?page=<?php echo $b;?>"><?php echo $b." ";?></a></li></ul>
<?php	
}
?>
</nav>
