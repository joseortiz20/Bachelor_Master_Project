   ...
   <div class="main main-raised">
		...
		<div class=" mainn mainn-raised">
			<!-- /container -->
			<img src="./img/JAOR Wallets & Shoes (1).png" alt="" >
		</div>
		<!-- /SECTION -->
					...
					<div class="col-md-12">
						<div class="hot-deal">
							<ul class="hot-deal-countdown">
								<li>
									<div>
										<img src="./img/gucci-1-logo-png-transparent.png" alt="" width="100" height="100">
										<!-- <h3>Gucci</h3> -->
									</div>
								</li>
								<li>
									<div>
										<img src="./img/Versace.png" alt="" width="100" height="110">
									</div>
								</li>
								<li>
									<div>
									<img src="./img/Chanel_logo_interlocking_cs.svg.png" alt="" width="100" height="80">
									</div>
								</li>
								<li>
									<div>
									<img src="./img/Prada_logo.png" alt="" width="110" height="40">							
									</div>
								</li>
							</ul>
							<h2 class="text-uppercase">Best High quality Brand</h2>
							<p>In One place</p>
